...
public class AchievementUnlocked {
    ...
    private void initGlobalFields() {
        if (!initiatedGlobalFields) {
            ...
            if (titleTextView == null) {
                if (VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 && isLarge) {
    ...
    private int getTargetWidth(AchievementData data) {
        ...
        textContainerFake.measure(MeasureSpec.UNSPECIFIED, MeasureSpec.UNSPECIFIED);
    ...
    private ValueAnimator getContainerStretchAnimation(int start, int end) {
        ...
        containerStretch.addUpdateListener(new AnimatorUpdateListener() {
            @Override
    ...
    private AnimatorSet getExitAnimation() {
        ...
        containerScale.addUpdateListener(new AnimatorUpdateListener() {
            @Override
    ...
    private AnimatorSet animateData(final AchievementData data) {
        ...
        if ((container.getTag() != null && container.getTag() != data)) {
            ...
            iconBgColor.addUpdateListener(new AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    if (!dismissed)
            ...
            bgColor.addUpdateListener(new AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    if (!dismissed)
        ...
        titleIn.addUpdateListener(new AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                if (dismissed) return;
        ...
        titleOut.addUpdateListener(new AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                if (dismissed) return;
        ...
        if (dataHasSubtitle) {
            ...
            subtitleIn.addUpdateListener(new AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    if (dismissed) return;
        ...
        if (dataHasSubtitle) {
            ...
            subtitleOut.addUpdateListener(new AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    if (dismissed) return;
...
final class WindowOverlayCompat {
    ...
    static final int TYPE_SYSTEM_ERROR = VERSION.SDK_INT < ANDROID_OREO ? WindowManager.LayoutParams.TYPE_SYSTEM_ERROR : TYPE_APPLICATION_OVERLAY;
}
